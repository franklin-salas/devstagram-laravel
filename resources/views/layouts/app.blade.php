    ...
    <header class="p-5 border-b bg-white shadow">
        <div class="container mx-auto flex justify-between">
            ...
            <nav class="flex gap-2 items-center">
                ...
                @auth
                <a href="{{route('post.create')}}" class="flex items-center gap-2 bg-white border p-2 text-gray-600 round text-sm uppercacse font-bold cursor-pointer"> 
                ...
                Hola : <span class="font-normal"> {{auth()->user()->name}}</span></a>
                ...
                <a href="{{ route('register.create') }}" class="font-bold uppercase text-gray-600">Crear cuenta</a>
                @endguest
